...
export const posts: Post[] = [
  {
    slug: "how-to-choose-a-keynote-speaker",
    title: "How to Choose a Keynote Speaker for Your Conference",
    date: "2025-04-10",
    readTime: "7 min read",
    category: "Event Planning",
    excerpt:
      "Most speaker-selection mistakes happen before the first phone call. Here is what to look for, what to ask, and what the red flags actually are.",
    keywords: [
      "keynote speaker",
    ...
    content: `HOW TO CHOOSE A KEYNOTE SPEAKER FOR YOUR CONFERENCE
...
For a full overview of Yossi's keynote programs, visit yossighinsberg.com/keynotes.`,
  ...
  {
    slug: "survival-keynote-speaker",
    title: "What Is a Survival Keynote Speaker — and Why Does It Work?",
    date: "2025-04-24",
    readTime: "6 min read",
    category: "Speaking",
    excerpt:
      "There is a difference between a speaker who talks about resilience and one who had to use it to stay alive. That difference is why the room goes quiet.",
    keywords: [
    ...
    content: `WHAT IS A SURVIVAL KEYNOTE SPEAKER
...
Learn more about Yossi's survival story at yossighinsberg.com/story.`,
  ...
  {
    slug: "amazon-survival-leadership-lessons",
    title: "21 Days Alone in the Amazon: What It Taught Me About Leadership",
    date: "2025-05-08",
    readTime: "8 min read",
    category: "Leadership",
    excerpt:
    ...
    content: `21 DAYS ALONE IN THE AMAZON: WHAT IT TAUGHT ME ABOUT LEADERSHIP
...
Find people who do not give up on the search. Be someone who does not give up on the search. In 40 years of speaking, I have never found a more useful definition of what a team is supposed to do.`,
  ...
  {
    slug: "resilience-speaker-what-to-look-for",
    title: "Booking a Resilience Speaker: What Actually Matters",
    date: "2025-05-15",
    readTime: "7 min read",
    category: "Event Planning",
    excerpt:
      "Resilience is the most requested keynote topic and the most frequently delivered badly. Here is the difference between a talk that performs and one that produces a shift.",
    keywords: [
      "resilience speaker",
      "resilience keynote speaker",
      "mental resilience speaker",
      "best resilience speaker",
    ],
    content: `BOOKING A RESILIENCE SPEAKER: WHAT ACTUALLY MATTERS
...
Yossi's keynote on Real Survival vs Imaginary Survival addresses exactly this — see yossighinsberg.com/keynotes/real-vs-imaginary-survival.`,
  ...
  {
    slug: "laws-of-the-jungle-leadership",
    title: "The Laws of the Jungle: What the Amazon Teaches About Leading People",
    date: "2025-05-22",
    readTime: "8 min read",
    category: "Leadership",
    excerpt:
      "The Amazon is four billion years old. It has already solved the problems organisations are paying consultants to solve. You just have to know where to look.",
    keywords: [
      "laws of the jungle leadership",
      "jungle leadership lessons",
      "Yossi Ghinsberg laws",
      "nature leadership principles",
    ],
    content: `THE LAWS OF THE JUNGLE: WHAT THE AMAZON TEACHES ABOUT LEADING PEOPLE
...
The full Laws of the Jungle framework is at yossighinsberg.com/laws.`,
  ...
  {
    slug: "keynote-speaker-financial-services",
    title: "What Makes a Keynote Speaker Right for Financial Services?",
    date: "2025-06-05",
    readTime: "7 min read",
    category: "Event Planning",
    excerpt:
      "Financial services conferences have specific demands — regulatory context, risk-aware audiences, and high stakes. Here is what to look for in a speaker who can meet them.",
    keywords: [
      "keynote speaker financial services",
      "financial services conference speaker",
      "insurance conference keynote",
    ],
    content: `WHAT MAKES A KEYNOTE SPEAKER RIGHT FOR FINANCIAL SERVICES?
...
Yossi Ghinsberg is available for financial services and insurance conferences globally. He speaks regularly to senior audiences in banking, insurance, wealth management, and professional services. To discuss whether he is right for your event, contact his bureau representatives or reach out directly through this site.`,
  ...
  {
    slug: "best-keynote-speakers-australia",
    title: "Booking a Keynote Speaker in Australia: What to Know",
    date: "2025-06-12",
    readTime: "7 min read",
    category: "Event Planning",
    excerpt:
      "A practical guide for Australian event planners, the local conference market, working with international speakers, and what Australian audiences actually respond to.",
    keywords: [
      "keynote speaker australia",
      "keynote speaker sydney",
      "keynote speaker melbourne",
      "australian conference speaker",
    ],
    content: `BOOKING A KEYNOTE SPEAKER IN AUSTRALIA: WHAT TO KNOW
...
To enquire about Yossi Ghinsberg for an Australian conference, you can reach him through Michael Arnot at Encore Speakers, who manages his bookings for Australia and Australasia, or contact this office directly.`,
  ...
  {
    slug: "keynote-speaker-fees-what-to-expect",
    title: "Keynote Speaker Fees: What You're Actually Paying For",
    date: "2025-06-19",
    readTime: "7 min read",
    category: "Event Planning",
    excerpt:
      "Speaker fees range from $3,000 to $300,000. The gap is not prestige. Here is what goes into a fee, what you should expect at each level, and what the red flags are.",
    keywords: [
    ...
    content: `KEYNOTE SPEAKER FEES: WHAT YOU'RE ACTUALLY PAYING FOR
...
Yossi Ghinsberg has been speaking professionally for over 30 years. His fee reflects a talk that is genuinely customised for every event, preparation calls included, with full travel transparency upfront. To discuss fees and availability, contact this office or reach out through his bureau representatives.`,
  ...
  {
    slug: "mdrt-keynote-speaker",
    title: "Speaking at MDRT: What the Main Stage Feels Like",
    date: "2025-06-26",
    readTime: "6 min read",
    category: "Speaking",
    excerpt:
      "10,000 of the top financial professionals in the world. One main stage. What it is like to stand in front of that room, and why the Amazon story lands with people who understand risk for a living.",
    keywords: [
      "MDRT keynote speaker",
      "MDRT main stage",
      "million dollar round table speaker",
    ],
    content: `SPEAKING AT MDRT: WHAT THE MAIN STAGE FEELS LIKE
...
Yossi Ghinsberg has spoken at MDRT and at major financial services conferences globally. To enquire about availability for your financial services event, reach out through this site or contact his North American bureau, Michelle Carter at Carter Global Speakers.`,
  ...
  {
    slug: "leadership-under-uncertainty",
    title: "Leadership Under Uncertainty: What the Amazon Actually Teaches",
    date: "2025-07-03",
    readTime: "8 min read",
    category: "Leadership",
    excerpt:
      "In October 1981, Yossi had to make decisions with no information, no rescue, and no margin for error. Three of those decisions map directly to what leaders face in volatile organisations.",
    keywords: [
    ...
    content: `LEADERSHIP UNDER UNCERTAINTY: WHAT THE AMAZON ACTUALLY TEACHES
...
Yossi Ghinsberg speaks on leadership under uncertainty for senior executive audiences, leadership offsites, and large-scale conferences. To enquire about having him at your event, contact this office or reach out through his bureau.`,
  ...
  {
    slug: "conference-speaker-vs-keynote-speaker",
    title: "Conference Speaker vs Keynote Speaker: What's the Difference?",
    date: "2025-07-10",
    readTime: "6 min read",
    category: "Event Planning",
    excerpt:
      "The terms are used interchangeably, but they describe different roles with different expectations, fees, and outcomes. Here is what actually distinguishes them.",
    keywords: [
      "conference speaker",
      "keynote speaker",
      "difference between keynote and conference speaker",
      "what is a keynote speaker",
    ],
    content: `CONFERENCE SPEAKER VS KEYNOTE SPEAKER: WHAT'S THE DIFFERENCE?
...
Yossi Ghinsberg speaks exclusively in keynote format: opening or closing plenary sessions for large conferences and leadership events. He does not do panel discussions or breakout sessions. If you are looking for a keynote that sets the tone for an entire conference or leadership event, contact this office to discuss fit and availability.`,
  ...
  {
    slug: "amazon-rainforest-survival-story",
    title: "The Amazon Survival Story That Became a Hollywood Film",
    date: "2025-07-17",
    readTime: "8 min read",
    category: "Leadership",
    excerpt:
    ...
    keywords: [
      ...
      "Jungle film Daniel Radcliffe",
      "amazon survival 1981",
    ],
...
Yossi Ghinsberg speaks at conferences and leadership events globally. To enquire about booking him for your event, contact this office or reach out through his bureau representatives.`,
  ...
  {
    slug: "virtual-keynote-speaker",
    title: "Booking a Virtual Keynote Speaker That Actually Works",
    date: "2025-07-24",
    readTime: "6 min read",
    category: "Event Planning",
    excerpt:
      "Most virtual keynotes fail because speakers treat them like Zoom calls. Here is what makes the difference, and what to look for when booking.",
    keywords: [
    ...
    content: `BOOKING A VIRTUAL KEYNOTE SPEAKER THAT ACTUALLY WORKS
...
To enquire about virtual keynote availability, contact this office directly. Virtual sessions are available across all time zones.`,
  ...
  {
    slug: "stress-management-keynote",
    title: "Why Stress Management Keynotes Usually Miss the Point",
    date: "2025-07-31",
    readTime: "7 min read",
    category: "Leadership",
    excerpt:
      "Most stress management keynotes give tips. Tips do not change the nervous system. Here is what actually does, and why the Amazon is the right context for that conversation.",
    keywords: [
      "stress management keynote",
      "stress keynote speaker",
      "workplace stress speaker",
      "burnout keynote",
    ],
    content: `WHY STRESS MANAGEMENT KEYNOTES USUALLY MISS THE POINT
...
Forty years later I am still working on the answer. Lino Cambi is the latest version of that work.`,
  },
  {
    ...
    category: "Speaking",
    excerpt:
      "The adventure speaker category has a problem. Most of it is spectacle. Here is what distinguishes a speaker whose experience has produced something transferable from one who just has a good story.",
    keywords: [
      "adventure keynote speaker",
      "adventure speaker",
      "extreme speaker",
      "expedition speaker",
    ],
    content: `ADVENTURE KEYNOTE SPEAKERS: SPECTACLE VS. SUBSTANCE
